...
const Hero = () => {
  return (
    ...
    w-full border-2 border-red-500 p-2 flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container ">

      <div className="relative xl:w-2/5 flex flex-col justify-center items=start w-full max-xl padding-x pt-28">
        <p className="text-xl font-montserrat text-coral-red">Our Summer Collections</p>

        <h1 className="mt-10 font-palanquin text-4xl max-sm:text-[72px] font-bold">
        ...
        <div className="flex jsutify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((stat) =>(
            <div key={stat.label}>
